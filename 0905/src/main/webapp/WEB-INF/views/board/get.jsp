...
<body>
    		...
    		replyService.getList({bno:bnoValue, page:1},function(list){
    			for(var i=0, len=list.length||0; i++){
    				console.log("전체 목록:"+list[i]);
    			}
    		});
    		
    		replyService.remove(7,function(count){
    			
    			console.log("갯수 확인:"+count);
    		...
    		replyService.update({rno : 6, bno:bnoValue, replytext:"수정합니다."},function(result){
    			alert("수정완료");
    		});
            		...
            		function showList(page){
            			replyService.getList({bno:bnoValue, page:page || 1},function(list){
                			...
                			for(var i=0, len=list.length || 0 ; i<len; i++){
                				...
                				str+=" <small class='pull-right text-muted'>"+/*replyService.displayTime(list[i].regdate)*/list[i].regdate+"</small></div>";
